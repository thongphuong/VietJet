...
namespace TMS.Core.Utils
{
    public static class DateUtil 
    {
        ...
        public static string DateToStringCertificate(DateTime? date, string format)
        {
            string result;
            ...
            {
                // If this line is reached, no exception was thrown
                result = date.Value.ToString(format, new CultureInfo("en-US"));
            }
            catch (Exception)
            {
                // If this line is reached, an exception was thrown
        ...
        public static DateTime StringToDate2(string strDate, string format)
        {
            DateTime result;
            try
            {
